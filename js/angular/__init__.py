...
angular_animate               = Resource(library, 'angular-animate.js',
                                         ...
                                         depends=[angular])
angular_aria                  = Resource(library, 'angular-aria.js',
                                         minified='angular-aria.min.js',
                                         depends=[angular])

angular_message_format        = Resource(library, 'angular-message-format.js',
                                         minified='angular-message-format.min.js',
                                         depends=[angular])

angular_message               = Resource(library, 'angular-messages.js',
...
angular_parse_ext             = Resource(library, 'angular-parse-ext.js',
                                         minified='angular-parse-ext.min.js',
                                         depends=[angular])

angular_csp                   = Resource(library, 'angular-csp.css')
